...
const props = {
    errors: { signupSuccess: { errors: 'Errors here' } },
...
describe('Input tests...', () => {
    ...
    it('should type in the Username', () => {
        ...
        expect(wrapper.state()).toEqual({
            user: { username: 'patrick', email: '', password: '' },
        })
    })
    it('should type in the Email', () => {
        ...
        expect(wrapper.state()).toEqual({
            user: { username: '', email: 'patrick@gmail.com', password: '' },
        })
    })
    ...
    it('should type in the Password', () => {
        ...
        expect(wrapper.state()).toEqual({
            user: { username: '', email: '', password: 'Example@1' },
        })
    })
